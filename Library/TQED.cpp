...
long TQED::getCount()
{
  ...
  Wire.write(TINYQED_READ_COUNTER);
...
{
  Wire.beginTransmission(deviceaddress);
  Wire.write(TINYQED_GET_COUNTERMIN);
  Wire.endTransmission();
...
{
  Wire.beginTransmission(deviceaddress);
  Wire.write(TINYQED_GET_COUNTERMAX);
  Wire.endTransmission();
...
{
  Wire.beginTransmission(deviceaddress);
  Wire.write(TINYQED_CENTER_COUNTER);
  Wire.endTransmission();
  return true;
}
...
{
  Wire.beginTransmission(deviceaddress);
  Wire.write(TINYQED_RESET_COUNTER);
  Wire.endTransmission();
  return true;
}
...
{
  Wire.beginTransmission(deviceaddress);
  Wire.write(TINYQED_GET_ADDRESS);
  Wire.endTransmission();
...
{
  Wire.beginTransmission(deviceaddress);
  Wire.write(TINYQED_SET_ADDRESS);
